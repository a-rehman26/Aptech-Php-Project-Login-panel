                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Student Registration Form!</h1>
                            </div>
...
?>
        ...
        if ($pass === $cPass) {
            ...
            $insert_query = " INSERT INTO `studentrecord`(`Fname`, `Lname`, `Qualification`, `Email`, `Password`, `Confirm Password`) VALUES ('$fname','$lname','$qualification', '$email','$pass_hash','$cPass_hash') ";
