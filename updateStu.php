...
<head>
    ...
    <title>Student Updated Form</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Student Update Form!</h1>
                            </div>
                            <form class="user" method="POST">
                                ...
                                $select_data_update = " SELECT * FROM studentrecord WHERE ID = '$fetch_id_values' ";
                                ...
                                if (isset($_POST['btnSubmit'])) {
                                    ...
                                    $email_validate = " SELECT * FROM studentrecord Where Email = '$email' ";
                                ...
                                ?>
                                        ...
                                        if ($pass === $cPass) {
                                            ...
                                            $update_query = "  UPDATE `studentrecord` SET `Fname`='$fname',`Lname`='$lname', `Qualification`='$qualification' ,`Email`='$email',`Password`='$pass_hash',`Confirm Password`='$cPass_hash' WHERE ID = '$id_fetch_update'  ";
